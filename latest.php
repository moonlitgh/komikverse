...
<head>
    ...
    <title>Latest Updates - DarkVerse</title>
...
<body class="bg-dark font-main text-gray-200">
    ...
    <section class="pt-24 pb-12 dark-gradient relative overflow-hidden">
        <div class="container mx-auto px-4 relative z-10">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 font-fantasy text-white text-center">Latest Updates</h1>
            <!-- Time Filter -->
            <div class="flex justify-center gap-4 mt-8">
                <button class="bg-flame text-white px-6 py-2 rounded">Today</button>
                <button class="bg-dark text-gray-400 px-6 py-2 rounded hover:bg-wine/20">Yesterday</button>
                <button class="bg-dark text-gray-400 px-6 py-2 rounded hover:bg-wine/20">This Week</button>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="mb-16">
                <div class="flex items-center gap-4 mb-8">
                    <h2 class="text-2xl font-bold flame-text font-fantasy">Today</h2>
                    <span class="text-gray-400">March 20, 2024</span>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="card-hover bg-dark border border-wine/30 rounded-lg overflow-hidden">
                        <div class="flex">
                            <img src="assets/images/comic1.jpg" alt="Comic Cover" class="w-32 h-40 object-cover">
                            <div class="p-4 flex-1">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="font-semibold text-lg text-flame">Demon's Path</h3>
                                    <span class="text-xs bg-blood/20 text-flame px-2 py-1 rounded">2 hours ago</span>
                                </div>
                                <p class="text-gray-400 text-sm mb-2">Chapter 156: The Dark Revelation</p>
                                ...
                                <button class="w-full bg-flame text-white py-2 rounded hover:bg-crimson transition-colors">Read Now</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mb-16">
                <div class="flex items-center gap-4 mb-8">
                    <h2 class="text-2xl font-bold flame-text font-fantasy">Yesterday</h2>
                    <span class="text-gray-400">March 19, 2024</span>
                </div>
                <!-- Similar grid of update cards -->
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-wine/5">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-8 flame-text font-fantasy">Release Schedule</h2>
            <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
                <!-- Day Schedule -->
                <div class="bg-dark border border-wine/30 rounded-lg p-4">
                    <h3 class="text-center text-flame font-bold mb-4">Monday</h3>
                    <div class="space-y-3">
                        <div class="text-sm">
                            <p class="text-gray-200 font-semibold">Dark Knights</p>
                            <p class="text-gray-400">Ch. 45 @ 18:00</p>
                        </div>
                        <!-- More scheduled releases -->
                    </div>
                </div>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-3xl font-bold flame-text font-fantasy">Continue Reading</h2>
                <button class="text-gray-400 hover:text-flame">View All</button>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <div class="card-hover bg-dark border border-wine/30 rounded-lg overflow-hidden">
                    ...
                    <div class="p-3">
                        ...
                        <p class="text-gray-400 text-xs mb-2">Chapter 23/45</p>
                        <div class="w-full bg-wine/20 rounded-full h-1">
                            <div class="bg-flame h-1 rounded-full" style="width: 50%"></div>
                        </div>
                    </div>
                </div>
                <!-- Repeat for more reading progress -->
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-wine/5">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-8 flame-text font-fantasy">Update Notifications</h2>
            <div class="max-w-2xl mx-auto bg-dark border border-wine/30 rounded-lg p-6">
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <label class="text-gray-200">Email Notifications</label>
                        <button class="w-12 h-6 bg-wine/20 rounded-full relative">
                            <span class="absolute right-1 top-1 w-4 h-4 bg-flame rounded-full"></span>
                        </button>
                    </div>
                    <div class="flex items-center justify-between">
                        <label class="text-gray-200">Browser Notifications</label>
                        <button class="w-12 h-6 bg-wine/20 rounded-full relative">
                            <span class="absolute right-1 top-1 w-4 h-4 bg-flame rounded-full"></span>
                        </button>
                    </div>
    ...
    <script>
        // Scroll Reveal dan fungsi lainnya
